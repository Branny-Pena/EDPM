...
${OBJECTDIR}/FuncionesColasEmpqt.o: FuncionesColasEmpqt.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FuncionesColasEmpqt.o FuncionesColasEmpqt.c

${OBJECTDIR}/FuncionesColasPs.o: FuncionesColasPs.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FuncionesColasPs.o FuncionesColasPs.c
