...
${OBJECTDIR}/FuncionesColasEmpqt.o: FuncionesColasEmpqt.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FuncionesColasEmpqt.o FuncionesColasEmpqt.c

${OBJECTDIR}/FuncionesColasPs.o: FuncionesColasPs.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FuncionesColasPs.o FuncionesColasPs.c
...
${OBJECTDIR}/FuncionesPolleria.o: FuncionesPolleria.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FuncionesPolleria.o FuncionesPolleria.c
